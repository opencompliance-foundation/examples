...
- `13` proved claims across the showcased corridors
...
- **Outcome**: `certificate_issued`
- **Claim summary**: proved `6`, attested `4`, failed `0`, stale `0`, judgment `0`, missing `0`
...
- **Corridors**: cyber-baseline, issued
- **Claim summary**: proved `4`, attested `0`, failed `0`, stale `0`, judgment `0`, missing `0`

### IRAP

- **Public position**: Family-level overlap only in the current public example packs, not a complete IRAP assessment.
- **Corridors**: cyber-baseline, issued
- **Claim summary**: proved `8`, attested `2`, failed `0`, stale `0`, judgment `0`, missing `0`
...
- **Claim summary**: proved `12`, attested `5`, failed `1`, stale `0`, judgment `1`, missing `0`
...
- **Corridors**: cyber-baseline, issued
- **Claim summary**: proved `3`, attested `0`, failed `0`, stale `0`, judgment `0`, missing `0`
...
- **Public position**: Crosswalked family-level support only in the cyber baseline corridor.
- **Corridors**: cyber-baseline, issued
- **Claim summary**: proved `8`, attested `0`, failed `0`, stale `0`, judgment `0`, missing `0`
...
- **Corridors**: cyber-baseline, failed, issued
- **Claim summary**: proved `12`, attested `3`, failed `1`, stale `0`, judgment `1`, missing `0`
