...
HUMAN_OWNER_SIGNER_ROLES = frozenset(
    {
        "security_training_owner",
        "platform_recovery_owner",
        "compliance_owner",
        "isms_owner",
        "project_security_owner",
        "remote_working_owner",
...
ACTOR_IDENTITIES: tuple[dict[str, Any], ...] = (
    ...
    {
        "identityId": "compliance-owner@exampleco.test",
        "actorType": "human",
        "defaultActorRole": "compliance_owner",
        "defaultSignerRole": "compliance_owner",
        "trustPolicyIds": [HUMAN_OWNER_ATTESTATION_POLICY_ID],
        "surfaces": ["evidence_claim"],
        "synthetic": True,
        "notes": "Synthetic compliance inventory owner for ExampleCo.",
    },
    {
    ...
    {
        "identityId": "isms-owner@exampleco.test",
        "actorType": "human",
        "defaultActorRole": "isms_owner",
        "defaultSignerRole": "isms_owner",
        "trustPolicyIds": [HUMAN_OWNER_ATTESTATION_POLICY_ID],
        "surfaces": ["evidence_claim"],
        "synthetic": True,
        "notes": "Synthetic ISMS stakeholder owner for ExampleCo.",
    },
    {
    ...
    {
        "identityId": "project-security-owner@exampleco.test",
        "actorType": "human",
        "defaultActorRole": "project_security_owner",
        "defaultSignerRole": "project_security_owner",
        "trustPolicyIds": [HUMAN_OWNER_ATTESTATION_POLICY_ID],
        "surfaces": ["evidence_claim"],
        "synthetic": True,
        "notes": "Synthetic project security owner for ExampleCo.",
    },
    {
    ...
    {
        "identityId": "remote-access-exporter",
        "actorType": "system",
        "defaultActorRole": None,
        "defaultSignerRole": None,
        "trustPolicyIds": [SYSTEM_EXPORT_POLICY_ID],
        "surfaces": ["evidence_claim"],
        "synthetic": True,
        "notes": "Synthetic remote-access posture export identity.",
    },
    {
        "identityId": "remote-work-owner@exampleco.test",
        "actorType": "human",
        "defaultActorRole": "remote_working_owner",
        "defaultSignerRole": "remote_working_owner",
        "trustPolicyIds": [HUMAN_OWNER_ATTESTATION_POLICY_ID],
        "surfaces": ["evidence_claim"],
        "synthetic": True,
        "notes": "Synthetic remote-working owner for ExampleCo.",
    },
    {
    ...
    {
        "identityId": "customer-support-owner@exampleco.test",
        "actorType": "human",
        "defaultActorRole": "customer_support_owner",
        "defaultSignerRole": "customer_support_owner",
        "trustPolicyIds": [HUMAN_OWNER_ATTESTATION_POLICY_ID],
        "surfaces": ["evidence_claim"],
        "synthetic": True,
        "notes": "Synthetic customer support owner for ExampleCo.",
    },
    {
        "identityId": "ethics-owner@exampleco.test",
        "actorType": "human",
        "defaultActorRole": "ethics_owner",
        "defaultSignerRole": "ethics_owner",
        "trustPolicyIds": [HUMAN_OWNER_ATTESTATION_POLICY_ID],
        "surfaces": ["evidence_claim"],
        "synthetic": True,
        "notes": "Synthetic ethics and IP governance owner for ExampleCo.",
    },
)
...
CONNECTOR_INGRESS_PROFILES: tuple[dict[str, Any], ...] = (
    ...
    {
        "profileId": "remote-access-exporter",
        "description": "Synthetic ingress profile for remote-access posture exports.",
        "actorIdentityId": "remote-access-exporter",
        "allowedClaimTypes": ["remote_access_posture_state"],
        "allowedSourceSystems": ["example-remote-access"],
        "allowedCollectionMethods": ["synthetic_export"],
        "allowedSourcePathPrefixes": ["exports/remote"],
    },
    {
...
DEFAULT_ACTOR_ROLE_BY_CLAIM_TYPE = {
    ...
    "corrective_action_process_attestation": "isms_owner",
    "corrective_action_followup_attestation": "isms_owner",
    "compliance_requirement_register_attestation": "compliance_owner",
    "compliance_requirement_review_attestation": "compliance_owner",
    "isms_stakeholder_register_attestation": "isms_owner",
    "isms_stakeholder_obligation_attestation": "isms_owner",
    "project_security_requirement_attestation": "project_security_owner",
    "project_security_review_attestation": "project_security_owner",
    "remote_working_attestation": "remote_working_owner",
    "code_of_conduct_attestation": "ethics_owner",
    "conduct_governance_attestation": "ethics_owner",
    "disciplinary_policy_attestation": "ethics_owner",
    "disciplinary_action_attestation": "ethics_owner",
    "internal_audit_program_attestation": "compliance_owner",
    "internal_audit_execution_attestation": "compliance_owner",
    ...
    "security_concern_intake_attestation": "incident_response_delegate",
    "security_concern_resolution_attestation": "incident_response_delegate",
    "lawful_basis_register_attestation": "privacy_delegate",
    "privacy_notice_attestation": "privacy_delegate",
    "privacy_impact_assessment_attestation": "privacy_delegate",
    "ai_supplier_transfer_attestation": "privacy_delegate",
    "data_retention_schedule_attestation": "privacy_delegate",
    "vendor_register_attestation": "privacy_delegate",
    "vendor_security_terms_attestation": "vendor_risk_delegate",
    "security_commitment_terms_attestation": "vendor_risk_delegate",
    "security_commitment_governance_attestation": "vendor_risk_delegate",
    "outsourced_development_requirement_attestation": "vendor_risk_delegate",
    "outsourced_development_review_attestation": "vendor_risk_delegate",
    "dsr_runbook_attestation": "privacy_delegate",
    "customer_support_channel_attestation": "customer_support_owner",
    "customer_support_governance_attestation": "customer_support_owner",
    "clear_desk_screen_policy_attestation": "remote_working_owner",
    "clear_desk_screen_coverage_attestation": "remote_working_owner",
    "security_community_membership_attestation": "project_security_owner",
    "security_community_output_review_attestation": "project_security_owner",
    "intellectual_property_policy_attestation": "ethics_owner",
    "intellectual_property_issue_attestation": "ethics_owner",
    ...
    "ai_human_review_trigger_attestation": "ai_oversight_delegate",
...
DEFAULT_DELEGATION_SCOPE_BY_CLAIM_TYPE = {
    ...
    "security_concern_intake_attestation": "security_concern_intake_governance",
    "security_concern_resolution_attestation": "security_concern_resolution_governance",
    "monitoring_review_attestation": "telemetry_review_governance",
    "lawful_basis_register_attestation": "lawful_basis_governance",
    "privacy_notice_attestation": "privacy_notice_governance",
    "privacy_impact_assessment_attestation": "privacy_impact_assessment_governance",
    "ai_supplier_transfer_attestation": "ai_supplier_transfer_governance",
    "data_retention_schedule_attestation": "retention_schedule_governance",
    "vendor_register_attestation": "privacy_supplier_governance",
    "vendor_security_terms_attestation": "high_risk_vendor_terms_review",
    "security_commitment_terms_attestation": "security_commitment_terms_review",
    "security_commitment_governance_attestation": "security_commitment_governance",
    "outsourced_development_requirement_attestation": "outsourced_development_requirements",
    "outsourced_development_review_attestation": "outsourced_development_review",
    ...
    "ai_human_review_trigger_attestation": "ai_human_review_trigger_governance",
