...
AI_GOVERNANCE_FIXTURE = FixtureSpec(
    ...
    next_actions=[
        ...
        "Add typed task-envelope, rights-ready run-trace, supplier-transfer, and live notice-publication artifacts so more of the AI corridor can answer privacy and accountability questions directly.",
