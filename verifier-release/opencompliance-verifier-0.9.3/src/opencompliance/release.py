...
PUBLIC_VERIFIER_RELEASED_AT = "2026-03-27T06:01:45Z"
PUBLIC_VERIFIER_LAYOUT_VERSION = 1
PUBLIC_VERIFIER_CONTRACT_ID = "opencompliance-public-verifier-contract-v6"
PUBLIC_VERIFIER_CONTRACT_VERSION = 6
...
def build_public_verifier_contract() -> dict[str, object]:
    return {
        ...
        "notes": [
            ...
            "System-export evidence claims are now constrained by a published connector-ingress registry keyed to registered system actor identities, but live-evidence verifier ingress and non-synthetic attestation roots remain future work.",
        ],
    }
