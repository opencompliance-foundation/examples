...
- Verifier-service and independent-witness identities are represented in the public trust-policy registry and signing or witness artifacts, even though the current public evidence corridors still only exercise system, human-owner, and delegated-approver evidence claims.
