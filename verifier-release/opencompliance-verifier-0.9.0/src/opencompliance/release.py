...
PUBLIC_VERIFIER_RELEASED_AT = "2026-03-25T22:51:32Z"
PUBLIC_VERIFIER_LAYOUT_VERSION = 1
PUBLIC_VERIFIER_CONTRACT_ID = "opencompliance-public-verifier-contract-v2"
PUBLIC_VERIFIER_CONTRACT_VERSION = 2
...
def build_public_verifier_contract() -> dict[str, object]:
    return {
        ...
        "notes": [
            ...
            "A live-evidence verifier contract with signer-bound ingress and wider connector coverage remains future work; the current contract is intentionally scoped to the public synthetic corridors.",
        ],
    }
