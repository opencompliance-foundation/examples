...
The two component certificates are narrower sub-corridor references used only for composition examples. Their embedded digests refer to synthetic component slices that are not currently published as standalone fixture roots.
