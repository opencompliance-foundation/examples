...
PUBLIC_VERIFIER_CONTRACT_ID = "opencompliance-public-verifier-contract-v1"
PUBLIC_VERIFIER_CONTRACT_VERSION = 1
...
def build_public_verifier_contract() -> dict[str, object]:
    return {
        ...
        "notes": [
            ...
            "A live-evidence verifier contract remains future work; the current contract is intentionally scoped to the public synthetic corridors.",
        ],
    }
